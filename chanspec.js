...
if (band == "1") { // ---- 5 GHz
if(wl_channel_list_5g instanceof Array && wl_channel_list_5g.toString() != ["0"].toString()){ //With wireless channel 5g hook or return not ["0"]
...
wl_channel_list_5g = eval('<% channel_list_5g(); %>');
extend_channel = ["<#40#>"]; // for 5GHz, extension channel always displays Auto
...
if (chanspecs[i] == 0)
document.form.wl_channel[i] = new Option("<#40#>", chanspecs[i]);
else
