...
document.getElementById('update_states').innerHTML="<#852#>";
}
},
success: function(){
...
document.getElementById('update_scan').style.display="none";
document.getElementById('update_states').innerHTML="<#104#><br><#1166#>";
}
else{
...
document.getElementById('update_states').innerHTML="<#132#>";
}
}
}
}
...
document.getElementById('update_states').innerHTML="<#832#>";
...
document.getElementById('loading_block3').innerHTML = "<div><#106#></div>";
}
else{
dead++;
}
...
document.getElementById("drword").innerHTML = "<#852#>";
return false;
}
},
success: function(){
...
document.getElementById("drword").innerHTML = "Memory space is NOT enough to upgrade on internet. Please wait for rebooting.<br><#1166#>"; /* untranslated */ //Untranslated.fw_size_higher_mem
return false;
}
else if(webs_state_error == 3){
document.getElementById("drword").innerHTML = "<#104#><br><#1166#>";
return false;
}
...
dr_advise();
document.getElementById("drword").innerHTML = "&nbsp;&nbsp;&nbsp;<#1167#>...";
isDownloading();
}
...
<div id="loading_block2" style="margin:5px auto; width:85%;"><#105#><br><#175#></div>
...
<tr>
<td>
<div class="drword" id="drword" style="">&nbsp;&nbsp;&nbsp;&nbsp;<#174#> <#171#>...</div>
</td>
</tr>
</table>
<!--[if lte IE 6.5]><iframe class="hackiframe"></iframe><![endif]-->
...
<div>&nbsp;</div>
<div class="formfonttitle"><#212#> - <#216#></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div class="formfontdesc"><strong><#1173#></strong>
<ol>
...
<div>
<div id="sig_check" class="button_helplink" style="margin-left:200px;margin-top:-25px;" onclick="sig_version_check();"><a target="_blank"><div style="padding-top:5px;"><#1436#></div></a></div>
<div>
...
<tr>
<th><#1169#></th>
<td><input type="text" name="firmver_table" class="input_20_table" value="<% nvram_get("buildno"); %>_<% nvram_get("extendno"); %>" readonly="1" autocorrect="off" autocapitalize="off">&nbsp&nbsp&nbsp<!--
<input type="button" id="update" name="update" class="button_gen" style="display:none;" onclick="detect_update();" value="<#1436#>" />
<div id="linkpage_div" class="button_helplink" style="margin-left:200px;margin-top:-25px;display:none;"><a id="linkpage" target="_blank"><div style="padding-top:5px;"><#1436#></div></a></div>
<div id="check_states">
...
<tr align="center">
<td colspan="2"><input type="button" name="upload" class="button_gen" onclick="submitForm()" value="<#887#>" /></td>
</tr>
</table>
</td>
</tr>
